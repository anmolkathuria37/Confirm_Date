                ...
                isYes ? (<Yes />
                    ...
                    <div className='flex flex-col mx-auto'>
                        ...
                        <div className='Buttons flex gap-4 mx-auto'>
                            ...
                            <button className={`bg-red-500 hover:bg-red-800 hover:cursor-pointer text-white px-2 py-2 transition-all duration-200 ease-in-out max-w-s text-wrap rounded-xl text-xl ${isMoved ? 'absolute' : ''}`} onClick={handleNoClick} onMouseEnter={moveNoButton} onTouchStart={moveNoButton} style={{ top: noPosition.top, left: noPosition.left }}> {noTexts[index]} </button>
